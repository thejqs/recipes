...
class ShiftingUnitsTestCase(TestCase):
    ...
    def test_method_conversion_dict_oz(self):
        ...
        total_oz = UnitShifter().by_weight(ingredient, new_serving_size, weight)
    ...
    def test_method_conversion_dict_tsp(self):
        ...
        total_tsp = UnitShifter().by_volume(ingredient, new_serving_size, volume)
    ...
    def test_by_volume_less_than_one(self):
        ...
        total_tsp = UnitShifter().by_weight(ingredient, new_serving_size, volume)
